...
public class Staff {
	...
	public Staff(String COMANT,String STAFF_ID){
		this.setCOMANT(COMANT);		
		this.setSTAFF_ID(STAFF_ID);
	}
	
	public Staff(String COMANT,String STAFF_ID,String FIRST_NAME,String LAST_NAME,String DATE_OF_BIRTH,String PHONE_NUMBER,String EMAIL,String ADDRESS, String ROLE){
